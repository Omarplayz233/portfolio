      ...
      <div className="grid size-full grid-rows-4">
        ...
        <div className="row-span-3 flex flex-col gap-3 p-3">
          ...
          <div className="flex flex-col gap-y-1 rounded-xl bg-secondary/50 p-3">
            <span className="text-base leading-none">{lanyard.data.discord_user.global_name}</span>
          ...
          <div className="flex grow rounded-xl bg-secondary/50 px-3 py-2">
            {hasMainActivity && mainActivity && mainActivity.assets ? (
              <div className="flex w-full items-center gap-x-3">
                {mainActivity.assets.large_image ? (
                  <div
                    ...
                    style={{
                      backgroundImage: `url('${mainActivity.assets.large_image.startsWith("mp:external/")
                        ? `https://media.discordapp.net/external/${mainActivity.assets.large_image.replace("mp:external/", "")}`
                  ...
                  >
                    {mainActivity.assets.small_image && (
                      <img
                        src={`${mainActivity.assets.small_image.startsWith("mp:external/")
                          ? `https://media.discordapp.net/external/${mainActivity.assets.small_image.replace("mp:external/", "")}`
              ...
              <div className="flex size-full flex-col items-center justify-center gap-1">
                <BedIcon className="h-full w-fit rounded-lg" />
                {/* <img */}
